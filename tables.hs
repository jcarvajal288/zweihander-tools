...
rollGender :: Integer -> String
rollGender n 
    | elem n [1..50]     = "Male"
    | elem n [51..100]   = "Female"
    | otherwise = error ("out of range die roll: " ++ (show n))

rollHumanAncestralModifiers :: Integer -> String
rollHumanAncestralModifiers n 
    | elem n [1..8]    = "Blessing in Disguise"
    | elem n [9..17]   = "Danger Sense"
    | elem n [17..25]  = "Dauntless"
    | elem n [26..33]  = "Esoteric Memory"
    | elem n [34..41]  = "Fortune's Wheel"
    | elem n [42..49]  = "Grim Resolve"
    | elem n [50..58]  = "Manifest Destiny"
    | elem n [59..67]  = "Mixed Bloodline"
    | elem n [68..76]  = "Mountain Amongst Men"
    | elem n [77..85]  = "Natural Selection"
    | elem n [86..92]  = "Noble Savage"
    | elem n [93..100] = "Seventh Sense"
    | otherwise = error ("out of range die roll: " ++ (show n))
...
rollAgeGroup :: Integer -> String
rollAgeGroup n 
    | elem n [1..25]     = "Young"
    | elem n [26..70]    = "Adult"
    | elem n [71..90]    = "Middle Aged"
    | elem n [91..100]   = "Elderly"
    | otherwise = error ("out of range die roll: " ++ (show n))

rollDistinguishingMarks :: Integer -> String
rollDistinguishingMarks n =
    case n of
        1 -> "Abnormally white teeth"
        2 -> "Abundance of freckles on face"
        3 -> "Acne-scarred face"
        4 -> "Additional toes or fingers"
        ...
        9 -> "Beaded mustachio"
        10 -> "Beady eyes"
        11 -> "Beauty mark on face"
        12 -> "Big ears"
        13 -> "Blood-shot eyes"
        14 -> "Bow-legged walk"
        15 -> "Branded with cattle iron"
        16 -> "Broken nose"
        17 -> "Buck-toothed or snaggle-toothed"
        18 -> "Bulging eyes"
        19 -> "Burn scars on face and arms"
        20 -> "Bushy eyebrows"
        21 -> "Carefully-groomed beard"
        22 -> "Cherubic face"
        23 -> "Clammy hands"
        24 -> "Claw marks over face"
        25 -> "Covered in black moles"
        26 -> "Curly locks of hair"
        27 -> "Devilish goatee"
        28 -> "Different colored eyes"
        29 -> "Dimpled cheeks"
        30 -> "Doll-like face"
        31 -> "Dropping eye"
        32 -> "Dry, flaking skin"
        33 -> "Ear half-missing"
        34 -> "Embarassing acne scars"
        35 -> "Embarrassing tattoo on face"
        36 -> "Excessive body hair"
        37 -> "Eyes too far apart"
        38 -> "False finger"
        39 -> "Farmer's tan"
        40 -> "Glasgow grin"
        41 -> "Golden lock of hair"
        42 -> "Hare lip"
        43 -> "Hooked nose"
        44 -> "Horse-faced"
        45 -> "Humpbacked"
        46 -> "Incredibly beautiful"
        ...
        58 -> "Long sideburns"
        59 -> "Milky eye"
        60 -> "Mismatched eye color"
        61 -> "Missing an eyebrow"
        62 -> "Missing fingers"
        63 -> "Nervous tic"
        64 -> "Older-looking face"
        65 -> "Painted beard"
        66 -> "Pallid countenance"
        67 -> "Patch of white hair"
        68 -> "Perfect posture"
        69 -> "Perpetual sneer"
        70 -> "Perpetually deep frown"
        71 -> "Piercing eyes"
        72 -> "Pigeon-toed stance"
        73 -> "Pot belly"
        74 -> "Pox scars all over body"
        75 -> "Pronounced brow"
        76 -> "Purple bags beneath eyes"
        77 -> "Rancid breath"
        78 -> "Rash of pimples"
        79 -> "Rheumy eyes"
        80 -> "Six-fingered hand"
        81 -> "Slouchy posture"
        82 -> "Spiked mohawk"
        83 -> "Squinting eyes or false eye patch"
        84 -> "Steely gaze"
        85 -> "Strong jaw"
        86 -> "Sunburn scars"
        87 -> "Sunken eyes"
        88 -> "Tanned, leathery skin"
        89 -> "Tarred and feathered"
        90 -> "Terribly crooked teeth"
        91 -> "Vacant expression"
        92 -> "Veteran's nose"
        93 -> "Vulgar tattoo"
        94 -> "Weak chin"
        95 -> "Wears spectacles"
        96 -> "Webbed hands and feet"
        97 -> "Widow's peak"
        98 -> "Wind-chapped cheeks"
        99 -> "Yellow scum on teeth"
        100 -> "Yellowed fingernails and toenails"
        _ -> error ("out of range die roll: " ++ (show n))
